...
var gvf_pagaIndex = null;
var gvf_eventName = null;
...
function gfn_renderPaging(params){
	...
	if($("#"+params.pageIndex).lenght == 0 || gfn_isNull(currentIndex) == true){
		currentIndex = 1;
	}
	...
	for(var i=first; i<(first+last); i++){
		if(i != currentIndex){
			...
			str += "<a gref='#this' class='pad_5' onclick='_movePage("+i+")'>"+i+"</a></b>";
		}
	}
...
function _movePage(value){
	$("#" + gvf_pageIndex).val(value);
	if(typeof(gvf_eventName) == "function"){
		gfv_eventName(value);
	}
	else {
